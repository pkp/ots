...
define('JOB_CONVERSION_STAGE_REFERENCE', 3);
define('JOB_CONVERSION_STAGE_HTML', 4);
define('JOB_CONVERSION_STAGE_PDF', 5);
define('JOB_CONVERSION_STAGE_XMP', 6);
define('JOB_CONVERSION_STAGE_BIBTEX', 7);
define('JOB_CONVERSION_STAGE_ZIP', 8);
