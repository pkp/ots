...
define('JOB_CONVERSION_STAGE_NER_EXTRACT', 17);
define('JOB_CONVERSION_STAGE_PARSCIT', 18);
define('JOB_CONVERSION_STAGE_GROBID', 19);
define('JOB_CONVERSION_STAGE_XMLFINAL', 20);
