...
/**
 * Tests the conversion path selection job when input is PDF
 */
class PathFinderPdfJobTest extends ModelTest
{
    /**
    ...
    /**
     * Location of the PDF input file to copy for testing.
     * @var string $testAsset
     */
    protected $testAsset = 'module/PathFinder/test/assets/document.pdf';
    /**
     ...
     * @return void
     */
    public function testPdfPathFinding()
    {
